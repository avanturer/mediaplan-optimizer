...
Кабинет — одна страница с липкой полосой этапов «Бриф · План · Ведение ·
Итог». Справа в полосе переключатель уровня. **«Кабинет»** — для
рекламодателя: бриф, план, кампания по часам, итог; без зёрен, сценариев и
стендов. **«Стенд»** — то же плюс техника: сценарии рынка, свои шоки,
стратегии, зерно мира, стресс-тест, сравнение на 20 мирах, таблица часа,
вердикт с зёрнами. Уровень запоминается в браузере; адрес `/?level=simple`
открывает «Кабинет» принудительно.

1. **Демо 1: бюджет есть, нужен максимум результата.** В шапке пример «1,2 млн ₽
   на 21 день». Бриф: задача, бюджет, срок, обещание «по прогнозу» или «с
   ...
   границей разброса; в «Стенде» — время расчёта. Таблица каналов: бюджет,
   ...
   разбросом; в «Стенде» — раскрывающийся блок «Как распределяли». Кнопки:
   «Утвердить план» (открывает ведение), «Что если бюджет ±10 %», в «Стенде» —
   «Стресс-тест: прогнать план через шоки» (семь шоков на одном мире).
2. **Демо 2: цель есть, нужен бюджет.** Пример «50 000 кликов за 14 дней» на
   узком пресете. Вердикт: недостижимо, максимум, на сколько меньше цели, во
...
3. **Демо 3: шок рынка и ведение по часам.** Раздел «Ведение кампании»
   открывается после утверждения. В «Стенде» рынок выбирается карточками с
   ...
   что делать. В «Стенде» ещё таблица каналов за час, стратегия, зерно мира,
   ...
   человека, таблица по каналам, хронология событий; в «Стенде» — порог кейса
   и вердикт с зёрнами.
