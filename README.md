...
**«Рекламодатель»** — бриф, план, кампания по часам, итог; без зёрен,
сценариев и стендов. **«Агентство»** — то же плюс техника: сценарии рынка,
...
`/?level=simple` открывает «Рекламодателя» принудительно, `/?level=tech` —
«Агентство». Шрифты Archivo и Golos Text лежат в `app/static/vendor/fonts`,
демо не зависит от сети.

1. **Демо 1: бюджет есть, нужен максимум результата.** Кнопка «Демо 1 · 1,2 млн ₽,
   21 день» на экране брифа. Бриф: задача, бюджет, срок, обещание «по прогнозу» или «с
   ...
   границей разброса; в уровне «Агентство» — время расчёта. Таблица каналов: бюджет,
   ...
   разбросом; в уровне «Агентство» — раскрывающийся блок «Как распределяли». Кнопки:
   «Утвердить план» (открывает ведение), «Что если бюджет ±10 %», в уровне «Агентство» —
   «Стресс-тест: прогнать план через шоки» (семь шоков на одном мире).
2. **Демо 2: цель есть, нужен бюджет.** Кнопка «Демо 2 · 50 000 кликов, узкий
   пресет». Вердикт: недостижимо, максимум, на сколько меньше цели, во
...
3. **Демо 3: шок рынка и ведение по часам.** Экран «Кампания по часам»
   открывается после утверждения. В уровне «Агентство» условия прогона лежат
   ...
   что делать. В уровне «Агентство» ещё таблица каналов за час, стратегия, зерно мира,
   ...
   человека, таблица по каналам, хронология событий; в уровне «Агентство» — порог кейса
   и вердикт с зёрнами.
