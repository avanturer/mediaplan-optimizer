...
2 619, но с разбросом вдвое шире. Режим «выжимать максимум» на тех же 100
мирах тратит бюджет по плану (отклонение по расходу 0,2 %) и даёт KPI в
среднем 2 763, на 22 % выше плана и на 5 % выше заморозки; по метрике кейса
это проигрыш заморозке (побед 36 %), потому что перевыполнение тоже
отклонение. Выбор режима это продуктовое решение, см.
`docs/business_position.md`; результаты в `results/maxmode_100.json`.
