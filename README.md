...
В брифе доступны три независимых переключателя: детектор качества трафика,
обученные кривые отклика и коррекция уникального охвата. В кампании —
одношаговые прогнозы, сигналы аномалий и парное сравнение того же алгоритма
с ML и без него. Функции экспериментальные, по умолчанию выключены; бандитов нет.
