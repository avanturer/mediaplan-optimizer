...
Вид «Просто» — для рекламодателя: бриф, план, кампания по часам, итог.

![Бриф: задача, бюджет, срок, каналы](docs/figures/cabinet/simple-01-brief.png)

![Медиаплан: прогноз с разбросом, бюджет, распределение по каналам](docs/figures/cabinet/simple-02-plan.png)

Кампания по часам: плеер сам останавливается там, где нужен человек — на карточке, ждущей решения, и на шоке рынка.

![Плеер: остановка на карточке, решение, шок дня 11](docs/figures/cabinet/player.gif)

![Кампания на дне 11: событие рынка, сводка, что делать](docs/figures/cabinet/simple-03-run-day11.png)

![Итог: обещали, получили, что дало ведение](docs/figures/cabinet/simple-04-summary.png)

Вид «Подробно» добавляет сценарии рынка, свои шоки, стресс-тест, таблицу часа и стенды на итоге; экран отказа — три варианта с посчитанным бюджетом. Снимки: `docs/figures/cabinet/tech-*.png`.
