...
| `world/` | модель мира и симулятор: `reset / step / inject_shock`, три профиля каналов, сценарии шоков | MLE #1 |
| `brain/` | планировщик (типы A и B, диагностика) и исполнитель (два контура, детектор, baseline'ы) | MLE #2 |
| `harness/` | стенд: ретро-пробы, цикл прогона, метрики, парное сравнение | MLE #2 |
