...
class Proposal(BaseModel):
    ...
    inaction_kpi_shortfall_pct: float | None = Field(default=None, description="сколько KPI к концу даёт ход против бездействия, в процентах от всего плана")
    inaction_kpi_shortfall_abs: float | None = Field(default=None, description="сколько KPI к концу даёт ход против бездействия, в единицах KPI")
