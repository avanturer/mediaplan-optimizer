...
миров у нас против 44 % у заморозки. Режим «выжимать максимум» тратит всё и
перевыполняет KPI, выбор режима это продуктовое решение
(`docs/business_position.md`). Гистограммы по мирам в `docs/figures/stand_hist_*.png`:
