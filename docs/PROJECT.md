...
как недорасход. Оба отклонения в пороге в 60 % миров против 44 % у заморозки,
побед по KPI 84–86 %. Резерв это ручка: режим «держать KPI на плане» даёт
медиану отклонения по KPI 0,2 % и 90 % миров в пороге по KPI, но недорасход
в среднем 28 %; режим «выжимать максимум» тратит всё и перевыполняет план на
...
15–17 %, заморозка расползается до 120 %.
